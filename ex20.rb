...
#open the input file in read mode assign the file object to current_file
current_file = open(input_file)

#print a string 
puts "First let's print the whole file:\n"

#call the print_all function, giving it the current_file object as a parameter 
...
##call the print_a_line function and give it 1 and the current_fie as parameters
current_line =1 
#the function prints 1, and the first line of the contents of current_file
print_a_line(current_line, current_file)

#increment the value of current_line by 1, current_loine is now 2
current_line= current_line + 1
#call the print_a_line function, give it the current_line variable and current_file as parameters
##the function print 2 and the second line of current_file
print_a_line(current_line, current_file)
